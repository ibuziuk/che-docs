...
For an example, below you can see comparison of a *Che 6 workspace configuration* and a *Che 7 devfile*. Both are *Java Vert.x* stacks with default project and default settings:
